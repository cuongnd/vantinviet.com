...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://banhangonl_bho:w7a8GNPjXb@localhost/banhangonl_bho2?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://banhangonl_bho:w7a8GNPjXb@localhost/banhangonl_bho2?new_link=true');
  }
}
...
$civicrm_root = '/home/banhangonl/domains/banhangonline88.com/public_html/administrator/components/com_civicrm/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/banhangonl/domains/banhangonline88.com/public_html/media/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://banhangonline88.com/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '8e66dae9127f5b785ac29bcbabe62078');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/banhangonl/domains/banhangonline88.com/public_html/media/civicrm/templates_c/mail.log');
// }
